          ...
          <Tabs defaultValue="account" className="w-[400px]">
            <TabsContent value="account">
              <Card className="widthcard">
                ...
                <CardFooter>
                  <Button className="rounded-md" onClick={capture}>
                    Capture Images
                  </Button>
                </CardFooter>
              </Card>
            ...
            <TabsContent value="password">
              <Card>
                ...
                <div className="flex">
                  ...
                  dsadassfsafa
                  <CardContent className="mt-10 bg-black"></CardContent>
                </div>
                <CardFooter>
                  <Button className="rounded-md" onClick={capture}>Capture Images</Button>
                </CardFooter>
              </Card>
            </TabsContent>
          </Tabs>
